...
public class File1 extends Activity {
    ...
    private static final String KEY_PREF_DIRECTORY = "file1_directory";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mButtonEnable.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                if (BruteRemote.mIO.checkConnection()) {
                    BruteRemote.mIO.setEnable(IO.CMD_FILE1_ENABLE, mButtonEnable.isChecked());
                }
            }
        });
        ...
        mSeekBarLevel.setOnSeekBarChangeListener(new OnSeekBarChangeListener() {
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                ...
                if (fromUser) {
                    if (BruteRemote.mIO.checkConnection()) {
                        BruteRemote.mIO.setLevel(IO.CMD_FILE1_LEVEL, toLevel(progress));
                    }
                }
            }
                    ...
                    .setPositiveButton(R.string.button_ok,
                        new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int whichButton) {
                                if (BruteRemote.mIO.checkConnection()) {
                                    BruteRemote.mIO.setFilename(IO.CMD_FILE1_FILENAME, IO.FILENAME_NONE);
                                    refreshData();
                                }
                            }
                        }
                        ...
                        .setPositiveButton(R.string.button_ok,
                            new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int whichButton) {
                                    ...
                                    if (BruteRemote.mIO.checkConnection()) {
                                        if (BruteRemote.mIO.setFilename(IO.CMD_FILE1_FILENAME, fullPath)) {
                                        	refreshData();
                                        }
                                        else {
