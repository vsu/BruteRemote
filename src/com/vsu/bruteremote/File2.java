...
public class File2 extends Fragment {
    ...
    public View onCreateView (LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.file2, container, false);

        mButtonEnable = (ToggleButton)v.findViewById(R.id.toggleButtonEnableFile2);
        ...
        final TextView textViewLevel = (TextView)v.findViewById(R.id.textViewLevelFile2);
        mSeekBarLevel = (SeekBar)v.findViewById(R.id.seekBarLevelFile2);
        ...
        final Button buttonBrowse = (Button)v.findViewById(R.id.buttonBrowseFile2);
        ...
        final Button buttonDelete = (Button)v.findViewById(R.id.buttonDeleteFile2);
        buttonDelete.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                TextView textViewFilename =
                        (TextView)getActivity().findViewById(R.id.textViewFilenameFile2);
                        ...
                        .setPositiveButton(R.string.button_ok,
                            new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int whichButton) {
                                    ...
                                    if (BruteRemote.mIO.checkConnection()) {
                                        BruteRemote.mIO.setFilename(IO.CMD_FILE2_FILENAME, fullPath);
                                    refreshData();
                                }
                            }
                            }
    ...
    private void refreshData() {
        if (BruteRemote.mIO.checkConnection()) {
            ...
            TextView textViewFilename = (TextView)getActivity().findViewById(R.id.textViewFilenameFile2);
            textViewFilename.setText(BruteRemote.mIO.getMetadata(IO.CMD_FILE2_FILENAME));

            TextView textViewMetadata = (TextView)getActivity().findViewById(R.id.textViewMetadataFile2);
